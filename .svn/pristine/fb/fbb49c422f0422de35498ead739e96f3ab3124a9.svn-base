 ...
 *
 * Torsten Ršmer, 2003-05-22: Made some slight modifications so that this
...
public class ImageGenerator implements ImageConsumer
{
     ...
     *
     * Torsten Ršmer: Ignore the status to make sure the process "finishes".
     ...
     *
     * Torsten Ršmer: Changed to public
     *
     ...
     * the current image.
     *
     * Torsten Ršmer: Use another constructor of BufferedImage. With the one used
